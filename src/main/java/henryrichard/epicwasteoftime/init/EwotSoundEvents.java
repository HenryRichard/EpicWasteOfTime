...
public abstract class EwotSoundEvents {
    ...
    public static final SoundEvent music_disc_strad = null;

    @SubscribeEvent
    public static void registerSounds(RegistryEvent.Register<SoundEvent> event) {
        event.getRegistry().registerAll(
                new SoundEvent(new ResourceLocation(EwotMain.MODID, "music_disc.strad")).setRegistryName("music_disc_strad")
        );
    }
