...
import henryrichard.epicwasteoftime.block.trees.LavaleafTree;
...
public abstract class EwotBlocks {
    ...
    public static void registerBlocks(RegistryEvent.Register<Block> event) {
        ...
        event.getRegistry().registerAll(
                ...
                new SaplingBlock(new LavaleafTree(), PlantType.Nether, (block) -> Tags.Blocks.NETHERRACK.contains(block), Block.Properties.create(Material.PLANTS).doesNotBlockMovement().tickRandomly().hardnessAndResistance(0f).sound(SoundType.PLANT)).setRegistryName("lavaleaf_sapling"),
